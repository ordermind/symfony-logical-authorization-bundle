...
htmlhelp_basename = 'LogicalAuthorizationBundledoc'
...
man_pages = [
    (master_doc, 'logicalauthorizationbundle', 'Logical Authorization Bundle Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LogicalAuthorizationBundle', 'Logical Authorization Bundle Documentation',
     author, 'LogicalAuthorizationBundle', 'One line description of project.',
     'Miscellaneous'),
]
