...
class UserIsAuthor implements FlagInterface
{
     ...
     *
     * @param array $context The context for evaluating the flag. The context must contain a 'user' key and a 'model'
     *                       key. The user needs to implement
    ...
    public function checkFlag(array $context): bool
    {
        ...
        if ($model instanceof ModelInterface) {
            ...
            // permission because the reason for this flag is to protect models that do have an author against other
            // users.
            if (!$author) {
                return true;
            }
