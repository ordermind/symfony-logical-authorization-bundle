...
interface PermissionTreeBuilderInterface {
   ...
   *
   * To collect the tree, this method fires the event 'logical_authorization.add_permissions' and passes Ordermind\LogicalAuthorizationBundle\Event\AddPermissionsEvent. It is then sorted by key in alphabetical order and cached with Symfony's Cache Component.
   *
