...
interface LogicalAuthorizationInterface {
  ...
  /**
   * Checks if access should be granted for a set of permissions in a given context. If something goes wrong an error will be logged and the method will return FALSE.
   *
